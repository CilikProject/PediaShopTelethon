...
from CilikUbot.events import cilik_cmd
from CilikUbot.utils import edit_delete, edit_or_reply
...
async def _(event):
    ...
    chat = "@tgscanrobot"
    sevent = await edit_or_reply(event, "Procesing...")
...
CMD_HELP.update(
    {
        ...
        \n\n**ᴄᴍᴅ :** `{cmd}stats`\
        \nv └⋟ Untuk memeriksa statistik pengguna\
        \n\n**ᴄᴍᴅ :** `{cmd}ustat` atau `.ustats`\
