...
from CilikUbot import BOT_USERNAME
from CilikUbot import CMD_HANDLER as cmd
from CilikUbot import CMD_HELP
from CilikUbot import S_PACK_NAME as packcustom
from CilikUbot import tgbot, user
...
async def kang(args):
    ...
    if isinstance(message.media, MessageMediaPhoto):
        xx = await args.reply(f"`{random.choice(KANGING_STR)}`")
        photo = io.BytesIO()
